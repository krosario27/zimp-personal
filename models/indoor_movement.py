...
class IndoorMovement(PlayerMovement):
    def check_environment(self, next_tile):
        """
        Checks and enforces movement restrictions when moving from indoor to outdoor.
        ...
        if self._player.current_tile.environment == "Indoor" and next_tile.environment == "Outdoor":
